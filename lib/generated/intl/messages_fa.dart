...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m6(minutes) => "${minutes} دقیقه";

  static String m7(seconds) => "Resend code in ${seconds} seconds";

  static String m8(appName) => "به ${appName} خوش آمدید!";

  static String m9(minutes) => "در ${minutes} دقیقه میرسد";
  ...
  static String m14(appName) => "${appName} کیف پول";

  static String m15(firstName) => "سلام ${firstName}!";
