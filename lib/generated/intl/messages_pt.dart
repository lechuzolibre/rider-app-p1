...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m8(appName) => "Bem-vindo ao ${appName}!";

  static String m9(minutes) => "Chegando em ${minutes}";
  ...
  static String m14(appName) => "Carteira ${appName}";

  static String m15(firstName) => "Olá ${firstName}!";
